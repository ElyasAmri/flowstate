...
1. [What Flowstate is](#1-what-flowstate-is)
2. [How it works](#2-how-it-works)
3. [Capabilities](#3-capabilities)
4. [Fanar integration (online and self-hosted)](#4-fanar-integration-online-and-self-hosted)
5. [Using Flowstate](#5-using-flowstate)
6. [Repository layout](#6-repository-layout)
7. [Project context (hackathon)](#7-project-context-hackathon)
